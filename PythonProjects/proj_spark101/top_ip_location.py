...
def extract_location(line):
    ...
    if reader is None:
        reader = Reader("/home/cloudera/spark-2.4.4-bin-hadoop2.6/maxmind/GeoLite2-City.mmdb")
...
if __name__ == "__main__":
    ...
    lines = sc.textFile("hdfs://localhost/user/cloudera/spark101/access_log/access_log/data")
